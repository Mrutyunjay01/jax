...
def _get_axis_resource_count(
  ...
  if in_positional_semantics and all(
      ips == _PositionalSemantics.GLOBAL for ips in in_positional_semantics):
...
def _get_axis_sizes(args_flat: Iterable[Any],
                    ...
                    in_positional_semantics: Sequence[bool],
                    out_positional_semantics: _PositionalSemantics):
    ...
    for name, dim in in_axes.items():
      ...
      try:
        ...
        raise ValueError(f"One of xmap arguments has an in_axes specification of "
                         ...
                         f"has rank {arg.ndim}")
      if ips == _PositionalSemantics.LOCAL and local_dim_size % resources.nlocal != 0:
        raise ValueError(f"One of xmap arguments has an in_axes specification of "
      ...
      if ips == _PositionalSemantics.LOCAL and name in global_axis_sizes:
        expected_local_dim_size = resources.to_local(out_positional_semantics,
                                                     global_axis_sizes[name])
